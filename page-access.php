...
<body>
	...
	<main class="main">
		...
		<div class="access">
			<div class="container">
				<div class="row">
					<h3 class="col-md-12"><span>福岡市内からもご来院しやすい久留米市。<br>各種交通機関・お車でアクセス可能です。</span></h3>
				</div>
				<div class="row access-contents">
					<div class="col-md-6">
						<div class="access-content">
							<h5 class="access-content-title">九州新幹線・JR鹿児島本線</h5>
							<div class="access-content-main">
					...
					<div class="col-md-6">
						<div class="access-content">
							<h5 class="access-content-title">西鉄電車</h5>
							<div class="access-content-main">
								<ul class="access-content-list">
									<li>・西鉄久留米駅より車で7分</li>
					...
					<div class="col-md-6">
						<div class="access-content">
							<h5 class="access-content-title">飛行機（福岡空港）</h5>
							<div class="access-content-main">
								<ul class="access-content-list">
					...
					<div class="col-md-6">
						<div class="access-content">
							<h5 class="access-content-title">お車（九州自動車道）</h5>
							<div class="access-content-main">
								<ul class="access-content-list">
